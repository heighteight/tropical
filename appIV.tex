...
The language we mainly consider in the main paper il the differential $\lambda$-calculus $\STDLC$, that we quickly define here, following [Section 3, \cite{Manzo2010}].
...
We finally recall the sound interpretation of $\STDLC$-terms in a $C\partial C$ category, following [Section 4.3, \cite{Manzo2010}].
...
One then defines a ``differential'' extension of usual $\beta$-reduction (see again [Section 3, \cite{Manzo2010}], or \cite{ER}), and thanks to the fact that $\C C$ is a $C\partial CC$, the interpretation above can can be proved to be sound for it ([Theorem 4.12, \cite{Manzo2010}]).
