...
Any tropical polynomials $\varphi:\Lawv^{X}\to\Lawv$ are $\mathrm{deg}(\varphi)$-Lipschitz continuous.
\end{corollary}


Using Corollary \ref{prop:polylip}, an immediate consequence of %the lines after Theorem~\ref{thm:modelsTaylor} is:
...
% 
%
%The proposition above, together with Theorem \ref{theorem:fepsilon}, can be used to show that tLs with \emph{finitely many} variables are always \emph{locally} Lipschitz over $(0,\infty)^{X}$. 
