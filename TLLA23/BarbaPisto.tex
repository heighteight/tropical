...
is the ``limit'' of the polynomials $\varphi_{n}$. %Since $\inf$s are not in general $\min$s, the behavior of tLS may be less predictable than that of tropical polynomials.
