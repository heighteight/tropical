...
\section{Preliminaries on Tropical (Linear and Non-Linear) Algebra}
\input{section2bis}


\section{Tropical Semantics of Effectful Programs: Two Examples}
...
\paragraph*{Allowed duplication/erasure: the $\STLC$ and a toy probabilistic $\lambda$-calculus $\STLC_\oplus$}\label{sec:STLC+STLCO}
...
\section{Conclusion}\label{section8} \input{section8}
