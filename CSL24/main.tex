...
\paragraph{Prohibited duplication/erasure: the \emph{linear} $\STLC$}\label{sec:3A}\input{section3A}

\paragraph{Allowed duplication/erasure: the $\STLC$}\label{sec:3B}\input{section3B}

\paragraph{Controlled duplication/erasure: the $\BSTLC$ and the $\STDLC$}\label{sec:3C}\input{section3C}


\section{Tropical Laurent Series}\label{sec:tls}\input{section4}
...
\subsection{Quantitaive analysis%: probabilistic, differential privacy
}\label{sec:app}
\input{section5}
%\input{section5C}
