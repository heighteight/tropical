...
As such, $(\LREL_!,D)$ is a model of the differential $\lambda$-calculus $\STDLC$ \cite{ER}, an extension of $\STLC$ ensuring exact control of duplications via a notion of linear substitution in its operational semantics.
