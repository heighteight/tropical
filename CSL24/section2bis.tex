...
This shows that tropicalisation is \emph{not} in general an injective operation and in fact, as we show in \autoref{theorem:fepsilon}, tps (in finitely many variables) have a tendency to collapse, if not globally at least locally, onto tropical polynomials.
