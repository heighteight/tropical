...
%\subsection{Two kinds of quantitative approaches}\label{section2}
...
\subsection{This paper and our contributions}
...
the metric approach usually yields Lipschitz conditions for affine programs, but what about ``unbounded'', simply typed $\lambda$-calculus (the ordinary one)?
