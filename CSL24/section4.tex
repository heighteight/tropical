...
\begin{tikzpicture}[thick,scale=0.7]
    ...
    \fill   (z) circle[radius=0pt]  node [xshift=-1cm, yshift=1.6cm] {$\overline{B_{2\delta}(z)}$};
    ...
    \fill   (x) circle[radius=2pt]  node [xshift=10mm, yshift=7mm] {$\overline{B_{\delta}(x)}$};

    \draw   (x) circle[radius=3cm] node {};
    \fill   (x) circle[radius=0pt]  node [xshift=-1.7cm, yshift=2cm] {$\overline{B_{3\delta}(x)}$};
\end{tikzpicture}
\end{center}
