...
Observe that on the hom-sets $\HOM{\LREL_{!}}{X}{Y}$ there are two natural notions of distance: the metric $\| f-g\|_{\infty}$ arising from the norm and the one arising from the usual $\sup$-metric $d_\infty(f,g):=\sup_{a\in X} d_\infty(f^{!}(a),g^{!}(a))$.
