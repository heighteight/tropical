...
If $\model *$ is finite, this is in particular the case for the interpretations of $\BSTLC$-terms, since then the interpretation of any $\BSTLC$-type $B$ is a finite set, and thus also $!_n \model B$ is.
% 
