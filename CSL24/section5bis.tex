...
\subparagraph*{Metric approach: bounded $\lambda$-terms as Lipschitz functions}
...
\subparagraph*{Resource approach: differential $\lambda$-terms as polynomials}
...
An intriguing similarity between program derivatives and 
